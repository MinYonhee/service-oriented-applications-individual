// ./routes/curriculos.js
import express from "express";
const router = express.Router();

// ==========================================================
// LER (READ) - GET /curriculos (Listar todos)
// ==========================================================
// Esta rota é rápida, pois busca apenas a tabela principal.
...
// ==========================================================
// LER (READ) - GET /curriculos/:id (Currículo detalhado)
// ==========================================================
router.get('/:id', async (req, res) => {
    ...
    try {
        ...
        // 🚀 OTIMIZAÇÃO CRÍTICA PARA O VERCEL:
        // Executa as duas consultas dependentes (experiências e formações) em paralelo.
        // Isso economiza latência de rede e reduz drasticamente o tempo total de resposta,
        // evitando o timeout de 10 segundos do serverless.
        const [experienciasResult, formacoesResult] = await Promise.all([
            // Query 1: Experiências
            req.db.query(
        ...
        // 3. Anexa os resultados ao objeto currículo
...
router.delete('/:id', async (req, res) => {
    const { id } = req.params;
    try {
        // O ON DELETE CASCADE na definição do banco de dados (que você mostrou)
        // garante que experiências e formações relacionadas serão deletadas
